...
export async function executeCall(
  ...
  if (await isDryRun()) {
    log.info('[DRY_RUN] Would execute call', { to: script.email, phone: script.phone, campaign: script.angle });
    return { callId: 'dry-run', provider: CALL_CONFIG.provider, phone: script.phone };
  }
